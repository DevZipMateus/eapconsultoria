...
const Hero = () => {
  ...
  return <section className="pt-20 pb-12 md:pt-36 md:pb-20 bg-gradient-to-br from-[#18252e] to-[#101c24] relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center py-[120px]">
