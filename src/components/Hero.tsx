...
const Hero = () => {
  ...
  return (
    <section className="pt-28 pb-12 md:pt-36 md:pb-20 bg-gradient-to-br from-[#18252e] to-[#101c24] relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in" style={{
            ...
            <a href="https://wa.me/61981200911" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-gray-100 text-[#18252e] px-6 py-3 rounded-md transition-all flex items-center justify-center gap-2">
              <span>Entrar em contato</span>
            </a>
            <a href="#services" className="bg-transparent hover:bg-white/10 text-white border border-white/30 px-6 py-3 rounded-md transition-all">
              Nossos serviços
            </a>
          </div>
        </div>
